        ...
        <div className="max-w-md text-center text-white">
          ...
          <div className="space-y-4 text-left">
            <div className="flex items-center gap-3">
              ...
              <span>{language === 'bn' ? 'বাংলায় সম্পূর্ণ কোর্স' : 'Complete Courses in Bengali'}</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-white/20">
                <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span>{language === 'bn' ? 'অভিজ্ঞ শিক্ষক' : 'Expert Teachers'}</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-white/20">
                <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span>{language === 'bn' ? 'সার্টিফিকেট প্রদান' : 'Certificate Provided'}</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-muted-foreground">
              {language === 'bn' ? 'বিনামূল্যে আজই শুরু করুন' : 'Start free today'}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-2">
              ...
              <span className="text-sm text-muted-foreground">
                {language === 'bn' ? 'আমি ' : 'I have read and agree to the '}
            ...
            <p className="text-center text-sm text-muted-foreground">
              ...
              <Link href="/(auth)/longin" className="font-medium text-primary hover:underline">
                {t('login')}
              </Link>
            </p>
          </form>
